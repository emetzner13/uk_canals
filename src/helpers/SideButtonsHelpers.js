...
export const buttonStyle =
	'cursor-pointer bg-white shadow p-2 px-4 rounded-full flex gap-2 group w-44 flex flex-row  hover:scale-105 transiation-all duration-200 hover:bg-gray-100';
